<p align="center">
<img width="850" height="670" alt="image" src="https://github.com/user-attachments/assets/0c7e3eae-52d5-4a46-b246-2e53285b3679" />
</p>
...
- Deploy DHCP onto the Windows Server
- Configure DHCP
...
## Verifying DHCP
### Verify that DHCP is enabled (User Interface), for this verification, you can tell if DHCP is either enabled or disabled due to the "Obtain an IP address automatically" radio option not being selected
<p>
